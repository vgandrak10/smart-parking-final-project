...
PATH_TO_MODEL_DIR = 'Path-to-Saved-Model' # download_model(MODEL_NAME, MODEL_DATE)
PATH_TO_LABELS = 'Path-to-labels-File' # download_labels(LABEL_FILENAME)
...
app.run(host="Your-System-IP-Address", port=5000, debug=True)
