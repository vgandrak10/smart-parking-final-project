...
def my_object_detection(image_np):
    ...
    # cv2.imwrite(f"/home/sai/Desktop/vihari_workspace/detected_images/{idx}.jpeg", image_np_with_detections)
    #matplotlib.image.imsave(f"/home/sai/Desktop/vihari_workspace/detected_images/{idx}.jpeg", image_np_with_detections)
    #plt.figure()
